<div class="container" style="margin-top: 100px; color: white !important; font-size: 1.7em;">
    ...
    <img class="img-fluid"  src="Vues/app/img/Accueil.jpg" alt="logo" style="position: absolute; left: 0px; top: 0px; right: 0px; z-index: -1; width: 100%; height: 500px; ">
</div>
<div class="container">
    <br><br>
    ...
    <center>
    <h4>
    Basée à Fontainebleau, Conciergin est une entreprise de service de proximité qui offre aux salariés des entreprises et aux usagers de la gare de Fontainebleau-Avon, l’occasion de résoudre les tracasseries du quotidien, et les demandes relevant de la sphère privée.
    </h4>
    </center>
</div>
<?php
