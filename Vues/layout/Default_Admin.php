                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="index.php?page=VueCommande">Commande en cours</a></li>
                                        <li role="separator" class="divider"></li>
                                        <li><a href="index.php?page=Explorer">Explorateur de fichier</a></li>
                                        <li role="separator" class="divider"></li>
                                        <li><a href="index.php?page=gestion-employer">Gérer les comptes</a></li>
                                        <li role="separator" class="divider"></li>
                                        <li><a href="index.php?page=ajouter-emp">Ajouter un compte</a></li>
                                    </ul>
                                </li>
                                </ul>
